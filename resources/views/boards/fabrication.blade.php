...
<div class="page-header">
  <div>
    <div class="page-title">Fabrication Queue</div>
    <div class="page-subtitle">{{ $jobs->count() }} job(s) in fabrication</div>
  </div>
</div>
...
<div class="card">
  <div class="tbl-wrap">
    <table>
      <thead>
        <tr><th>Job ID</th><th>Title</th><th>Client</th><th>Branch</th><th>Priority</th><th>Deadline</th><th>Actions</th></tr>
      </thead>
      <tbody>
        @forelse($jobs as $job)
        ...
        @empty
          <tr><td colspan="7"><div class="empty-state"><div class="empty-icon">🔩</div><p>No jobs in fabrication</p></div></td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
